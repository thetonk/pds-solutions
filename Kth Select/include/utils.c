...
void printCommandUsage(char *progname){
    printf("[USAGE] ./%s <input file path> <number of elements> <element position to search>\n", progname);
    printf("[USAGE] ./%s -l <URL> <element position to search>\n", progname);
    printf("[USAGE] ./%s -f <input file path> <number of elements> <element position to search>\n", progname);
}
