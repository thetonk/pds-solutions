...
__global__ void calculateNextLatticeV1(int8_t *curLattice, int8_t *nexLattice, size_t n){
...
int main(int argc, char *argv[]){
    ...
    for(size_t i = 0; i < epochs; ++i){
        calculateNextLatticeV1<<< block_count, block_size >>>(current_lattice_state, next_lattice_state, elementsPerRow);
